...
${locator_create_ownvehicle_grouptype}                    xpath=//*[@id="root"]/div/div/main/div/div/div[2]/div/form/div[1]/div/div[2]/div/div[2]/div/div/div
...
${locator_create_ownvehicle_create_grouptype_guide}       name=guide_staff
...
${locator_create_ownvehicle_create_grouptype_warning_cc}  xpath=/html/body/div[5]/div/div[2]/div/div[2]/div/div[1]/div/div/div[4]/div[1]/button
${locator_create_ownvehicle_create_grouptype_warning_sa}  xpath=/html/body/div[5]/div/div[2]/div/div[2]/div/div[1]/div/div/div[4]/div[2]/button
${locator_create_ownvehicle_create_grouptype_closeicon}   xpath=/html/body/div[3]/div/div[2]/div/div[2]/div/div/div[1]/div[1]/div[2]
...
${locator_create_ownvehicle_warning_cancel}               xpath=/html/body/div[6]/div/div[2]/div/div[2]/div/div[1]/div/div/div[4]/div[1]/button
${locator_create_ownvehicle_warning_ok}                   xpath=/html/body/div[6]/div/div[2]/div/div[2]/div/div[1]/div/div/div[4]/div[2]/button
...
${locator_ownvehicle_search_check_search}                 xpath=//*[@id="root"]/div/div/main/div/div[3]/div/div/div/div/div/div/div/table/tbody/tr[1]/td[2]
${locator_ownvehicle_filter}                              xpath=//*[@id="root"]/div/div/main/div/div[2]/div[2]/button
${locator_ownvehicle_filter_grouptype}                    xpath=/html/body/div[3]/div/div[2]/div/div[2]/div/div/div[1]/div[2]/form/div/div[1]/div/div/div
...
${locator_ownvehicle_filter_status}                       xpath=/html/body/div[3]/div/div[2]/div/div[2]/div/div/div[1]/div[2]/form/div/div[3]/div/div/div
...
${locator_ownvehicle_action_view}                         xpath=/html/body/div[4]/div/ul/li[1]/span/div
${locator_ownvehicle_action_delete}                       xpath=/html/body/div[4]/div/ul/li[2]/span/div
...
${locator_ownvehicle_view_grouptype}                      xpath=//*[@id="root"]/div/div/main/div/div/div[2]/div/form/div[1]/div/div[2]/div/div[2]/div/div/div/span[1]
...
${locator_ownvehicle_edit_status_ac_inac}                 xpath=/html/body/div[4]/div/div
${locator_ownvehicle_edit_vehicleplate}                   name=vehicle_plate
${locator_ownvehicle_edit_grouptype}                      xpath=//*[@id="root"]/div/div/main/div/div/div[2]/div/form/div[1]/div/div[2]/div/div[2]/div/div/div/span[2]
    ## หากมีการดำเนินการแล้วต้องเปลี่ยน name ใหม่ ให้อ้างอิงจากที่มีอยู่ในลิส
${locator_ownvehicle_edit_grouptype_chose1}               name=baba
    # Add group type in create own vehicle    
${locator_ownvehicle_edit_create_grouptype}               xpath=/html/body/div[5]/div/div/div[4]/div/div/button
    ## table group type in create own vehicle    
...
${locator_ownvehicle_edit_grouptype_pagina}               xpath=/html/body/div[3]/div/div[2]/div/div[2]/div/div/div[1]/div[2]/div/div[1]/div/div/div/div/div/ul/li[9]/div/div[1]/span[1]
${locator_ownvehicle_edit_grouptype_pagina_25}            xpath=//*[@id="rc_select_14_list_1"]/div
...
${locator_ownvehicle_edit_create_grouptype_warning_cc}    xpath=/html/body/div[6]/div/div[2]/div/div[2]/div/div[1]/div/div/div[4]/div[1]/button
${locator_ownvehicle_edit_create_grouptype_warning_save}  xpath=/html/body/div[6]/div/div[2]/div/div[2]/div/div[1]/div/div/div[4]/div[2]/button
${locator_ownvehicle_edit_create_grouptype_closeicon}     xpath=/html/body/div[3]/div/div[2]/div/div[2]/div/div/div[1]/div[1]/div[2]
...
${locator_ownvehicle_edit_warning_cancel}                 xpath=/html/body/div[4]/div/div[2]/div/div[2]/div/div[1]/div/div/div[4]/div[1]/button
${locator_ownvehicle_edit_warning_ok}                     xpath=/html/body/div[4]/div/div[2]/div/div[2]/div/div[1]/div/div/div[4]/div[2]/button

# Check Pagination
${locator_ownvehicle_pagination}                          xpath=//*[@id="root"]/div/div/main/div/div[3]/div/div/div/div/ul/li[4]/div/div
${locator_ownvehicle_pagination_25page}                   xpath=//*[@id="rc_select_12_list_1"]
${locator_ownvehicle_pagination_15page}                   xpath=//*[@id="rc_select_12_list_0"]
